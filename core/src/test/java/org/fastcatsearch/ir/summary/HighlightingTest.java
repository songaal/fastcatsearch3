...
//
//    	str1 = "일이라면 언제나 가장 열성적으로 저를 지지해주는 후원자이기도 하셨습니다. 어린 시절부터 저는 집안의 장남으로서 동생과 부모님을 돌보며 자신의 것만을 고집하기보다는 다른 사람들과 화합하는 방법들을 자연스럽게 터득하며 성장하였습니다. 이러한 저의 가정환경은 훗날 제가 책임감이 강하고 성실한 사람으로 발전하";
//    	str2 = "어린 시절부터 집안의 장남으로서 동생을 돌보며 자신의 것만을 고집하기보다는 다른 사람들과 화합하는 방법들을 자연스럽게 터득하며 성장하였습니다. ";
//    	str2 = "어린";
//    	
