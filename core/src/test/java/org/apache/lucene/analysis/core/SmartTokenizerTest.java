...
//
//	@Test
//	public void testSmartTokenizer() throws IOException {
//		
//		String text = null;
...
////		text = "ㅇ /ㄴㅇ라머    ㅣㄴ어/  미ㅏ널;";
//		SmartTokenizer tokenizer = new SmartTokenizer(new StringReader(text));
//		tokenizer.reset();
...
//		SmartTokenizer tokenizer = new SmartTokenizer(null);
...
//		char[] chars = "한engABC123-~!@#$%^&*()_".toCharArray();
