...
public class GroupHitBak {
	...
	public GroupHitBak(Query q, Schema schema, int docCount, SearchIndexesReader searchFieldReader, FieldIndexesReader fieldIndexesReader
