...
// *
// */
//public abstract class DataInput3 extends InputStream implements Cloneable {
//	protected static Logger logger = LoggerFactory.getLogger(IndexInput.class);
//
//	/**
...
//
//	public void readBytes(BytesBuffer bytesBuffer) throws IOException {
//		readBytes(bytesBuffer.bytes, bytesBuffer.offset, bytesBuffer.length);
//	}
//
//	public abstract void seek(long p) throws IOException;
//
...
//			throw new Error("This cannot happen: Failing to clone StreamInput");
//		}
//	}
//
//	
