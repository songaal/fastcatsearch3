...
//	private ArrayList<HighlightInfo> summary;
	...
	public Hit(Query q, Schema schema, int baseDocNo, int docCount, SearchIndexesReader searchFieldReader, FieldIndexesReader fieldIndexesReader
...
//				filterTime += (System.currentTimeMillis() - st);
			}
