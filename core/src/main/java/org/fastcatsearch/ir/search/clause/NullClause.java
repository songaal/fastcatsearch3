...
class NullOperatedClause extends OperatedClause {
	public NullOperatedClause(String collectionId) { super(collectionId); }
	@Override protected void initClause(boolean explain) { }
	@Override protected boolean nextDoc(RankInfo docInfo) { return false; }
	@Override public void close() { }
	@Override public void printTrace(PrintStream os, int depth) { }
}
