...
public final class StandardTokenizer extends Tokenizer {
	...
	public static final String[] TOKEN_TYPES = new String[] { "<ALPHANUM>", "<APOSTROPHE>", "<ACRONYM>", "<COMPANY>", "<EMAIL>", "<HOST>", "<NUM>", "<CJ>",
			"<ACRONYM_DEP>", "<SOUTHEAST_ASIAN>", "<IDEOGRAPHIC>", "<HIRAGANA>", "<KATAKANA>", "<HANGUL>" };
	 ...
	 */
	public StandardTokenizer(AttributeSource source, Reader input) {
		super(source, input);
		init();
	}
