...
<script type="text/javascript" src="<%=FASTCAT_MANAGE_ROOT%>js/searchStat.js"></script>
<script>
	var typeTag = "<%=type%>";
...
<div id="sidebar">
	<div class="sidebox">
		<h3>통계</h3>
			<ul class="latest">
			<li><a href="<%=FASTCAT_MANAGE_ROOT%>monitoring/resourceStat.jsp">리소스통계</a></li>
			<li><a href="<%=FASTCAT_MANAGE_ROOT%>monitoring/searchStat.jsp" class="selected">검색통계</a></li>
			</ul>
	</div>
	<div class="sidebox">
		<h3>통계</h3>
...
<div id="mainContent">
		...
		<div style="float:left;width:100%;height:30px;">
			...
			%>
			<select name="collection" id="collection" onchange="changeSelect();">
				<option value="__global__" >전체</option>
		...
		<div style="width:100%;height:30px;padding:20px;">
			<a href="javascript:changeTab('hit');" id="a_hit" class="btn_s">검색처리수</a>
			<a href="javascript:changeTab('fail');" id="a_fail" class="btn_s">검색실패수</a>
			<a href="javascript:changeTab('achit');" id="a_achit" class="btn_s">누적처리수</a>
			<a href="javascript:changeTab('acfail');" id="a_acfail" class="btn_s">누적실패수</a>
			<a href="javascript:changeTab('max');" id="a_max" class="btn_s">최대응답시간</a>
			<a href="javascript:changeTab('ave');" id="a_ave" class="btn_s">평균응답시간</a>
		</div>
		
		<div id="graphDiv" style="width:100%;height:300px;">
			<div id="hitDiv" class="chartContainer">
				<div id="chartSearchActDiv" class="chartDiv"></div>
			</div>
			<div id="failDiv" class="chartContainer">
				<div id="chartSearchFailDiv" class="chartDiv"></div>
			</div>
			<div id="achitDiv" class="chartContainer">
				<div id="acchartSearchActDiv" class="chartDiv"></div>
			</div>
			<div id="acfailDiv" class="chartContainer">
				<div id="acchartSearchFailDiv" class="chartDiv"></div>
			</div>
			<div id="maxDiv" class="chartContainer">
				<div id="chartMaxDiv" class="chartDiv"></div>
			</div>
			<div id="aveDiv" class="chartContainer">
				<div id="chartAveDiv" class="chartDiv"></div>
			</div>
		</div>
