...
java -Xmx512m -Dlogback.configurationFile=%CONF%\logback.xml -Dfile.encoding=UTF-8 -Dderby.stream.error.file=logs/db.log -classpath %FASTCAT_CLASSPATH% org.fastcatsearch.server.CatServer %IR_HOME%
