...
public class TokenizerServlet extends WebServiceHttpServlet {
	
	private static final long serialVersionUID = -1112551982298988153L;
	private static final Logger logger = LoggerFactory.getLogger(TokenizerServlet.class);

	public TokenizerServlet(int resultType) {
		super(resultType);
	}
