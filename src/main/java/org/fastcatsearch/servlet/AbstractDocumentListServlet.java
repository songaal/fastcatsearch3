...
public abstract class AbstractDocumentListServlet extends WebServiceHttpServlet {
	...
	public AbstractDocumentListServlet(int resultType) {
		super(resultType);
	}
	...
	protected abstract Job createDocumentListJob(String queryString);		

	protected abstract AbstractDocumentListResultWriter createSearchResultWriter(Writer writer);
