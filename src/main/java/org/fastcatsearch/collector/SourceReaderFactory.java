	...
	public static SourceReader createSourceReader(String collection, Schema schema, DataSourceSetting dsSetting, boolean isFull) throws IRException{
		if(dsSetting.isMultiSource()){
			...
			if(dsSetting.sourceType.equalsIgnoreCase("FILE")){
				SourceReader sourceReader = (SourceReader) IRSettings.classLoader.loadObject(dsSetting.fileDocParser, new Class[]{Schema.class, DataSourceSetting.class, Boolean.class}, new Object[]{schema, dsSetting, isFull});
				...
				SourceReader sourceReader = (SourceReader) IRSettings.classLoader.loadObject(dsSetting.customReaderClass, new Class[]{Schema.class, DataSourceSetting.class, Boolean.class, Properties.class}, new Object[]{schema, dsSetting, isFull});
				logger.debug("Loading sourceReader : {}, {}", dsSetting.fileDocParser, sourceReader);
				if(sourceReader == null){
