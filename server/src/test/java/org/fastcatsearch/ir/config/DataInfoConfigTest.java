...
public class DataInfoConfigTest {
	...
	public void testDataInfoWrite() throws JAXBException {
		...
		SegmentInfo segmentInfo = new SegmentInfo("a0", "1234-5678", 200, 100, 10, 0,Formatter.formatDate(new Date()));
		dataInfo.getSegmentInfoList().add(segmentInfo);
		segmentInfo = new SegmentInfo("a1", "2345-6789", 400, 350, 20, 0, Formatter.formatDate(new Date()));
		dataInfo.getSegmentInfoList().add(segmentInfo);
