...
public class SingleScheduledJob extends ScheduledJob {
	...
	public SingleScheduledJob(String key, Job job, Date startTime, int periodInSecond) {
		super(key);
		this.actualJob = job;
	...
	public SingleScheduledJob(String key, String jobClassName, String args, Date startTime, int periodInSecond) {
		super(key);
	...
	public JobResult doRun() throws FastcatSearchException {
		...
		try {
			...
			//다음 스케쥴을 위해 다시 한번 schedule job 등록.
			if (!isCanceled) {
