...
public class CopyOfIncIndexJob extends IndexingJob {
	...
	public JobResult doRun() throws FastcatSearchException {
		...
		try {
			...
			boolean useSeparateAddIndexing = true;//dataPlanConfig.isSeparateIncIndexing();
...
//				updateAndDeleteSize[1] += appender.getDuplicateDocCount();//중복문서 삭제카운트. 엄밀하게는 업데이트 카운트. 
				...
				//
				SegmentInfo segmentInfo = currentSegmentInfo.getNextSegmentInfo();
