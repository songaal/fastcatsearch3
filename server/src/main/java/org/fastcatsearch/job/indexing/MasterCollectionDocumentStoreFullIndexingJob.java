...
public class MasterCollectionDocumentStoreFullIndexingJob extends MasterNodeJob {
	...
	public JobResult doRun() throws FastcatSearchException {
		...
		CollectionDocumentStoreFullIndexingJob documentStoreJob = new CollectionDocumentStoreFullIndexingJob(newCollectionContext);
		...
		if (jobResult != null) {
			...
			logger.debug("CollectionDocumentStoreFullIndexingJob result = {}", obj);
