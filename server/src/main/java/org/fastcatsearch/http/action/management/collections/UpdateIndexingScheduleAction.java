...
public class UpdateIndexingScheduleAction extends AuthAction {
	...
	public void doAuthAction(ActionRequest request, ActionResponse response) throws Exception {
		...
		boolean fullActive=false, 
				addActive=false;
		ScheduleType fullScheduleType=ScheduleType.REGULAR_PERIOD, 
				addScheduleType=ScheduleType.REGULAR_PERIOD;
		String fullStartDateTime="",
				addStartDateTime="";
		int fullPeriodInSecond=0, 
				addPeriodInSecond=0;
		...
		try {
			...
			File scheduleConfigFile = collectionContext.collectionFilePaths().file(
					SettingFileNames.scheduleConfig);
