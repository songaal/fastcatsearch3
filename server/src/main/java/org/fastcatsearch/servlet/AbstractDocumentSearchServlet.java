...
public abstract class AbstractDocumentSearchServlet extends WebServiceHttpServlet {
	...
	public AbstractDocumentSearchServlet(int resultType) {
		super(resultType);
	}
	...
	protected abstract Job createDocumentSearchJob(String queryString);		

	protected abstract AbstractDocumentSearchResultWriter createSearchResultWriter(Writer writer);
	...
	public String queryString() {
		try {
			return "cn=" + collectionName + "&fl=" + URLDecoder.decode(fields, requestCharset) + "&se="
					...
					"&id="
					+ URLDecoder.decode(id, requestCharset);
